...
case $size in
	...
	1367368) #mainstd EU ZR 140 variant 17202
		set -A offsets E45C4 E45C5 E45C6 E45C7 E4660 E4661 E4662 E4663 ;;
	1423060) #mainstd EU ZR 254 variant 17201
		set -A offsets EE8B4 EE8B5 EE8B6 EE8B7 EE94C EE94D EE94E EE94F ;;
	1599792) #mainstd EU ZR 369 variant 17202
		set -A offsets FF298 FF299 FF29A FF29B FF330 FF331 FF332 FF333 ;;
	1599808) #mainstd EU ZR 369 variant 37202
		set -A offsets FF290 FF291 FF292 FF293 FF328 FF329 FF32A FF32B ;;
	1604996) #mainstd EU ZR 480 variant 17202
		set -A offsets 101258 101259 10125A 10125B 1012F0 1012F1 1012F2 1012F3 ;;
	1919734|1919750) #cpu EU PQ 240 variant 17215, 47209, cpuplus US PQ 241 variant 17218, 17220
		set -A offsets 151380 151381 151382 151383 151418 151419 15141A 15141B ;;
	1921758|1921742) #cpu US/EU ZR 241 variant 17210/47204
		set -A offsets 151824 151825 151826 151827 1518BC 1518BD 1518BE 1518BF ;;
	1919783) #cpu EU PQ 245 variant 17217
		set -A offsets 1513B0 1513B1 1513B2 1513B3 151448 151449 15144A 15144B ;;
	1919767) #cpuplus US PQ 245 variant 17220, 247 variant 17218
		set -A offsets 151390 151391 151392 151393 151428 151429 15142A 15142B ;;
	1921791) #cpu EU ZR 245 variant 37207
		set -A offsets 151854 151855 151856 151857 1518EC 1518ED 1518EE 1518EF ;;
	1923559) #cpuplus EU ZR 252/253 variant 37205
		set -A offsets 151E74 151E75 151E76 151E77 151F0C 151F0D 151F0E 151F0F ;;
	1921551) #EU PQ 247/252 variant 17222
	...
	1920023) #US ZR 253
		set -A offsets 151214 151215 151216 151217 1512AC 1512AD 1512AE 1512AF ;;
	1921535) #US PQ 254
		set -A offsets 1519B0 1519B1 1519B2 1519B3 151A48 151A49 151A4A 151A4B ;;
	1923543) #US ZR 254 variant 17208
	...
	2186198|2186230) #EU/RoW ZR 346/359 variant 17213
		set -A offsets 15CC90 15CC91 15CC92 15CC93 15CD24 15CD25 15CD26 15CD27 ;;
	2186206) #EU PQ 351 v.17214
		set -A offsets 15CC98 15CC99 15CC9A 15CC9B 15CD2C 15CD2D 15CD2E 15CD2F ;;
	2187958) #EU PQ 353
		set -A offsets 15D2B8 15D2B9 15D2BA 15D2BB 15D34C 15D34D 15D34E 15D34F ;;
	2187950|2187982|2187983) #EU/US PQ/ZR 353/356/357/359
		set -A offsets 15D2B0 15D2B1 15D2B2 15D2B3 15D344 15D345 15D346 15D347 ;;
	2189718) #EU PQ variant 37210, ZR 359/360/480 variant 37207
	...
	2186303) #CN ZR 361, PQ 367 variant 17222
		set -A offsets 15CCEC 15CCED 15CCEE 15CCEF 15CD80 15CD81 15CD82 15CD83 ;;
	2188055|2188079) #EU/US PQ 363/370 variant 17214/17218/17220, ZR 367 variant 37204
		set -A offsets 15D314 15D315 15D316 15D317 15D3A8 15D3A9 15D3AA 15D3AB ;;
	2186582) #EU ZR 363 variant 47202
		set -A offsets 15CDDC 15CDDD 15CDDE 15CDDF 15CE70 15CE71 15CE72 15CE73 ;;
	2188047|2188071) #EU PQ 363 v.37213, ZR 361 v.37207, 366 v37207, 367 v17224, ZR 367 v17217
	...
	2197495) #EU ZR 369 variant 37206
		set -A offsets 15EB70 15EB71 15EB72 15EB73 15EC04 15EC05 15EC06 15EC07 ;;
	2197503) #EU PQ 369 37211, ZR 369 37204
		set -A offsets 15EB78 15EB79 15EB7A 15EB7B 15EC0C 15EC0D 15EC0E 15EC0F ;;
	2195727) #EU PQ 431
		set -A offsets 15ED34 15ED35 15ED36 15ED37 15EDC8 15EDC9 15EDCA 15EDCB ;;
	2200790) #EU PQ/ZR 449
		set -A offsets 15F7C8 15F7C9 15F7CA 15F7CB 15F85C 15F85D 15F85E 15F85F ;;
	2200798) #EU PQ 449 v.17214
		set -A offsets 15F7D0 15F7D1 15F7D2 15F7D3 15F864 15F865 15F866 15F867 ;;
	2202574|2202550) #US PQ 447 variant 17218, EU ZR 462 variant 47202
		set -A offsets 15FDF0 15FDF1 15FDF2 15FDF3 15FE84 15FE85 15FE86 15FE87 ;;
	2202566|2202542) #US PQ 447 variant 17220, EU ZR 462 variant 47204
	...
	2201779|2201803) #EU ZR 472/CN/RoW PQ 475/478
		set -A offsets 161294 161295 161296 161297 161328 161329 16132A 16132B ;;
	2195751) #cpu EU PQ 370 var 17216, 478/480/604 variant 17206/17217
